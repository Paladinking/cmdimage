...
#ifdef MEM_ABORT_ERROR
#define Mem_alloc(size) xmalloc(size)
#define Mem_realloc(ptr, size) xrealloc(ptr, size)
#else
#define Mem_alloc(size) malloc(size)
#define Mem_realloc(ptr, size) realloc(ptr, size)
#endif

#define Mem_salloc(size) malloc(size)
#define Mem_srealloc(ptr, size) realloc(ptr, size)

#define Mem_xalloc(size) xmalloc(size)
#define Mem_xrealloc(ptr, size) xrealloc(ptr, size)
